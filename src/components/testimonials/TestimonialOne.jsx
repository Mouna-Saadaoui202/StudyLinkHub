    ...
    <section className="td_heading_bg td_hobble">
      ...
      <div className="container">
        <div
          ...
          data-wow-delay="0.2s"
        >
          <h2 className="td_section_title td_fs_48 mb-0 td_black_color">
            Start your journey With Us
          </h2>
          <p className="td_section_subtitle td_fs_18 mb-0 td_black_color td_opacity_7">
                ...
                <div className="td_slider_wrapper">
                  <SlickSlider {...settings}>
                    <div className="td_slide">
                      <div className="td_testimonial td_style_1 td_black_bg td_radius_5">
