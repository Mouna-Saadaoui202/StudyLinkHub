...
import videoBg from "../../assets/img/student.jpg";
import { VideoPlayer } from "./VideoPlayer";

export const VideoOne = () => {
  return (
    <section>
      <div className="td_height_70 td_height_lg_80" />
      <div
      ...
      >
        <div className="td_contact_box td_style_1 td_accent_bg td_radius_10">
          ...
          <div className="td_contact_box_right">
            ...
            <h3 className="td_fs_28 mb-0 td_white_color">
              <a href="tel:+21670877053">+216 70 877 053</a> <br />
              <a href="tel:+21626253080">+216 26 253 080</a>
            </h3>
          </div>
        </div>
        <div className="td_height_120 td_height_lg_50" />
