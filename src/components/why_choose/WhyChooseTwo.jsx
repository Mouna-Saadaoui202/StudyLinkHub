        ...
        <div className="row align-items-center td_gap_y_40">
          ...
          >
            <div className="td_section_heading td_style_1 td_mb_30">
              ...
              <p>
                We offer a variety of services for individuals, companies, 
                and institutions coming to or living in Tunisia.
            ...
            <div className="td_tabs td_style_1 td_mb_40">
              <div className="td_mb_40">
                <ul className="td_tab_links td_style_4 td_mp_0 td_semibold td_accent_color">
                  <li className="active">
                    <a href="#td_tab_1">Accommodation Assistance</a>
                  </li>
                  <li>
                    <a href="#td_tab_2">Translation Services</a>
                  </li>
                  <li>
                    <a href="#td_tab_3">Administrative Support</a>
                  </li>
                  <li>
                    <a href="#td_tab_4">Event Planning & Organizing</a>
                  </li>
                </ul>
              </div>
