...
import heroImg from "../../assets/img/scholar.jpg";
    ...
    <section className="td_hero td_style_8 td_center td_accent_bg td_hobble">
      <div className="container">
        ...
        >
          ...
          We are here to support students at every stage
          </h1>
          <p className="td_hero_subtitle td_fs_18 td_white_color td_opacity_7 td_mb_30">
          Through our platform, we offer two main types of scholarships for students wishing to study in China and Germany
          </p>
