...
import campusLife1 from "../../assets/img/p1.webp";
import campusLife2 from "../../assets/img/p2.webp";
import campusLife3 from "../../assets/img/p3.webp";
import campusLife4 from "../../assets/img/p4.webp";
        ...
        <div className="row td_gap_y_40">
          ...
          >
            ...
            <div className="td_section_heading td_style_1">
              ...
              China & Germany: A Bridge for Learning and Culture
              </h2>
              <p className="td_section_subtitle td_fs_18 mb-0 td_white_color td_opacity_7">
              China and Germany, rich in history and innovation, 
              offer a unique opportunity for cultural and professional 
              growth. From China’s rapid tech advancements to Germany’s precision 
              engineering, both nations complement each other, fostering new perspectives 
              and collaboration. Embracing their cultures enhances global understanding, 
            ...
            <div className="row">
              <div className="col-sm-6">
                <div
                  ...
                  data-wow-delay="0.2s"
                >
                  <Link to="/contact" className="td_card_thumb d-block">
                    <img
                      src={campusLife1}
                      alt="Campus Life"
                      className="w-100"
                  ...
                  <div className="td_card_info">
                    ...
                    <Link to="/contact" className="td_card_btn">
                      <svg
                        width="23"
                        height="24"
                        viewBox="0 0 23 24"
